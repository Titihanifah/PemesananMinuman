...
Public Class Toping
    Sub tampilToping()
        ...
        DA = New MySqlDataAdapter("SELECT id 'ID', nama 'Toping' , harga 'Harga' , stock_toping 'Stok' from toping", Conn)
        DS = New DataSet
        DA.Fill(DS, "toping")
    ...
    Private Sub Tambah_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        Try
            Call bukaDB()
            CMD = New MySqlCommand("SELECT id from toping WHERE id = '" & txtIdT.Text & "'", Conn)
            ...
            Else
                ...
                simpan = "INSERT INTO toping (id, nama, harga, stock_toping) VALUES (?,?,?,?)"
    ...
    Sub tampilCombo()
        Call bukaDB()
        CMD = New MySqlCommand("SELECT id from toping", Conn)
        RD = CMD.ExecuteReader
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            Call bukaDB()
            hapus = "DELETE FROM toping WHERE id=@p1"
            CMD = Conn.CreateCommand
            With CMD
                .CommandText = hapus
                .Connection = Conn
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            ubah = "UPDATE toping SET nama = @p2, harga = @p3, stock_toping = @p4 WHERE id = @p1"
            CMD = Conn.CreateCommand
            With CMD
                .CommandText = ubah
                .Connection = Conn
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        Call bukaDB()
        CMD = New MySqlCommand("SELECT * FROM toping WHERE id ='" & ComboBox1.Text & "'", Conn)
        RD = CMD.ExecuteReader
        RD.Read()
